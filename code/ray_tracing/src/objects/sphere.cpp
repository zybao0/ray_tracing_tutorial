...
{
	sphere::sphere(const vec::vec3 &o,const vec::real &r):o_(o),r_(r)
	{
		box_=aabb(o-vec::vec3(r,r,r),o+vec::vec3(r,r,r));
		not_optimization_=0;
	}
	const vec::real& sphere::r()const{return r_;}
	const vec::vec3& sphere::o()const{return o_;}
	bool sphere::hit(const ray &sight,vec::real t_min,vec::real t_max,hitpoint &rec)const
	{
